...
inline MV_ColMat_COMPLEX::MV_ColMat_COMPLEX(COMPLEX* d,  int m, int n, MV_Matrix_::ref_type i ) :
  v_(d, m * n, MV_Vector_::ref), dim0_(m), dim1_(n), lda_(m), ref_(i)
{
}

inline MV_ColMat_COMPLEX::MV_ColMat_COMPLEX( MV_ColMat_COMPLEX & A, MV_Matrix_::ref_type i ) :
  v_(&A(0, 0), A.dim(0) * A.dim(1), MV_Vector_::ref),
  dim0_(A.dim(0) ), dim1_(A.dim(1) ), lda_(A.lda() ), ref_(i)
{
}

inline MV_ColMat_COMPLEX::MV_ColMat_COMPLEX(COMPLEX* d,  int m,  int n, int _lda, MV_Matrix_::ref_type i) :
