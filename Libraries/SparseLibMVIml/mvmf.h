...
inline MV_ColMat_float::MV_ColMat_float(float* d,  int m, int n, MV_Matrix_::ref_type i ) :
  v_(d, m * n, MV_Vector_::ref), dim0_(m), dim1_(n), lda_(m), ref_(i)
{
}

inline MV_ColMat_float::MV_ColMat_float( MV_ColMat_float & A, MV_Matrix_::ref_type i ) :
