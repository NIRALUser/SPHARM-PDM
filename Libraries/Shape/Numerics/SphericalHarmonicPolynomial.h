...
public:
  ...
  void ComputePrincipalCurve (unsigned int from_l, unsigned int to_l, double startPhi, double startTheta, double *curve, double stepSize, int curveLength) ;
  ...
  void GetGradKappa (unsigned int from_l, unsigned int to_l, unsigned int family, double phi, double theta, double *gradKappa) ;
  void GetOneRidgePoint (unsigned int from_l, unsigned int to_l, unsigned int family, double *uv, double *point) ;
  void FollowRidge (unsigned int from_l, unsigned int to_l, unsigned int family, double *startPoint, double *uv, double *point, double stepSize) ;
...
protected:
  ...
  void ComputePrincipalCurveUV (unsigned int from_l, unsigned int to_l, double startPhi, double startTheta, double *curve, double stepSize, int curveLength) ;
