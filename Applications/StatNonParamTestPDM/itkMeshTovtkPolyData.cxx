...
itkMeshTovtkPolyData::itkMeshTovtkPolyData()
{
...
void itkMeshTovtkPolyData::SetInput(TriangleMeshType::Pointer mesh)
{
  m_itkTriangleMesh = mesh;
  this->ConvertitkTovtk();
}

vtkPolyData * itkMeshTovtkPolyData::GetOutput()
{
  return m_PolyData;
}

void itkMeshTovtkPolyData::ConvertitkTovtk()
{
