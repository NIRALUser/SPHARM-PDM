...
double computeStatisticValue( vnl_matrix<double>& A, vnl_matrix<double>& B, vnl_matrix<double>& C,
                              vnl_matrix<double>& X, vnl_matrix<double>& Y, vnl_matrix<double>& E,
                              vnl_matrix<double>& H,
                              vnl_matrix<double>& precompAA, vnl_matrix<double>& precompXPseudoInverse,
                              vnl_matrix<double>& NDtmp,
                              vnl_matrix<double>& PPtmp, vnl_matrix<double>& DDtmp, vnl_matrix<double>& NNtmp,
                              vnl_matrix<double>& AAtmp,
                              vnl_matrix<double>& Ctmp,
                              int computeStatisticsType );
